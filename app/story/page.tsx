...
export default function StoryPage() {
  ...
  return (
    <>
      {/* Hero header */}
      <section className="relative overflow-hidden bg-gradient-to-b from-amber-100/50 to-background pt-32 pb-16 dark:from-amber-950/10 dark:to-background">
      ...
      <Section className="pt-0">
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          ...
          <div className="min-w-0">
            <MagicCard className="border-amber-200/50 dark:border-amber-950/15">
            ...
            <BlurFade className="my-12" yOffset={20}>
              <blockquote className="border-l-4 border-amber-600 pl-6 text-xl font-medium italic leading-relaxed text-foreground/80">
            ...
            <BlurFade className="mt-12" yOffset={20}>
              <div className="rounded-2xl border border-amber-400/40 bg-gradient-to-br from-amber-50/80 to-rose-50/40 p-8 dark:border-amber-900/20 dark:from-amber-950/15 dark:to-rose-950/5">
                <article className="prose">
          ...
          <BlurFade delay={0.2} yOffset={20}>
            <div className="sticky top-24 space-y-3">
              <h3 className="text-xs font-semibold uppercase tracking-widest text-amber-700 dark:text-amber-600">
                Key moments
              </h3>
              {keyMoments.map((moment) => (
                <div
                  key={moment.label}
                  className="flex items-start gap-3 rounded-xl border border-amber-200/50 bg-surface/60 p-3 dark:border-amber-800/10 dark:bg-surface/30"
                >
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-600/20 to-amber-700/20">
                    <moment.icon className="h-4 w-4 text-amber-700 dark:text-amber-600" />
                  </div>
                  <div>
